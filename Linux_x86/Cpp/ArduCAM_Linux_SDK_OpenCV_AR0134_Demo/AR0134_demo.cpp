...
int main(int argc, char** argv )
{
    ...
    ArduCam_writeSensorReg( useHandle,0x3056, 0x4A);
    ArduCam_writeSensorReg( useHandle,0x3058, 0x70);
    ArduCam_writeSensorReg( useHandle,0x305a, 0x70);
    ArduCam_writeSensorReg( useHandle,0x305c, 0x4A);
