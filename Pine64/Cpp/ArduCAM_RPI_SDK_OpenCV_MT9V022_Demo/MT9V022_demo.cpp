//Arducam SDK multi-thread example for MT9V022 Monochrome camera
//This demo is only demonstrate how to use the Arducam SDK functions, 
//Tested under Pine64 ubuntuMATE16.04 OS Opencv 2.4.13
//Compile with command: g++ MT9V022_demo.cpp -o Test `pkg-config --cflags --libs opencv` -lArduCamLib -lpthread -lusb-1.0 -L. -I. -std=gnu++11
